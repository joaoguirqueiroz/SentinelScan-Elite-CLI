...
- `tests/test_scanner_modules.py`: modulos Nmap/Nuclei/smart scan, cancelamento sem autorizacao, confirmacao extra, relatorios por ferramenta, correlacao e historico.
